...
def bot(formatted_data: dict, clifor: str, insc_est: str = None) -> None:
    ...
    smart_pyautogui.smart_click(image_path=r'C:\Users\gabriel.souza\Desktop\automation\assets\images\menu.png')

    smart_pyautogui.smart_click(image_path=r'C:\Users\gabriel.souza\Desktop\automation\assets\images\fechar.png')

    pyautogui.hotkey('ctrl', 'insert')

    smart_pyautogui.smart_press(key='tab', flag_path=r'C:\Users\gabriel.souza\Desktop\automation\assets\images\cadastro_aberto.png')
    ...
    if 'C' in clifor.upper():
        smart_pyautogui.smart_click(image_path=r'C:\Users\gabriel.souza\Desktop\automation\assets\images\cliente.png')

    if 'F' in clifor.upper():
        smart_pyautogui.smart_click(image_path=r'C:\Users\gabriel.souza\Desktop\automation\assets\images\fornecedor.png')

    smart_pyautogui.smart_click(image_path=r'C:\Users\gabriel.souza\Desktop\automation\assets\images\juridica.png')
    ...
    if insc_est and 'x' not in insc_est.lower():
        smart_pyautogui.smart_click(image_path=r'C:\Users\gabriel.souza\Desktop\automation\assets\images\tributos.png')
        smart_pyautogui.smart_click(image_path=r'C:\Users\gabriel.souza\Desktop\automation\assets\images\tipo_contribuinte.png')
    ...
    # Salva o cadastro
    smart_pyautogui.smart_click(image_path=r'C:\Users\gabriel.souza\Desktop\automation\assets\images\salvar.png')

    # Espera o cadastro terminar e fecha a aba
    smart_pyautogui.smart_click(x=114, y=168, flag_path=r'C:\Users\gabriel.souza\Desktop\automation\assets\images\flag_filtro.png')
